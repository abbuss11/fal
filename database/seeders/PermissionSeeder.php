...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['code' => 'teams.read', 'label' => 'Equipes - lecture'],
            ['code' => 'teams.create', 'label' => 'Equipes - creation'],
            ['code' => 'teams.update', 'label' => 'Equipes - mise a jour'],
            ['code' => 'teams.delete', 'label' => 'Equipes - suppression'],
            ['code' => 'teams.manage_members', 'label' => 'Equipes - gestion des membres'],
