<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h1 class="mt-1 text-2xl font-semibold client-heading-accent">Nouvelle equipe</h1>
                <p class="mt-1 text-sm text-slate-500">Creation d'une equipe avec son noyau de membres.</p>
            </div>
    ...
    <div class="client-shell space-y-5">
        ...
        <section class="client-panel p-5">
            <form method="POST" action="{{ route('client.teams.store') }}">
                @csrf
                @include('client.teams.partials.form', ['submitLabel' => 'Creer l\'equipe'])
            </form>
        </section>
    </div>
</x-app-layout>
